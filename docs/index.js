...
(function($PS) {
  ...
  var tileNo = function (v) {
      ...
      throw new Error("Failed pattern match at Mahjong.Hand (line 58, column 1 - line 58, column 22): " + [ v.constructor.name ]);
  };
  ...
  var succTile = function (v) {
      ...
      throw new Error("Failed pattern match at Mahjong.Hand (line 71, column 1 - line 71, column 25): " + [ v.constructor.name ]);
  }; 
  ...
  var handToList = function (v) {
      if (v instanceof Hand) {
          var mentsuToList = function (v1) {
              ...
              throw new Error("Failed pattern match at Mahjong.Hand (line 142, column 5 - line 142, column 45): " + [ v1.constructor.name ]);
          };
      ...
      throw new Error("Failed pattern match at Mahjong.Hand (line 139, column 1 - line 139, column 33): " + [ v.constructor.name ]);
  };
  ...
  var isHand = function (h) {
      return checkCounts(handToList(h)) && (function () {
          ...
          throw new Error("Failed pattern match at Mahjong.Hand (line 134, column 3 - line 136, column 62): " + [ h.constructor.name ]);
      })();
  };
  exports["Manzu"] = Manzu;
  exports["Pinzu"] = Pinzu;
...
(function($PS) {
  ...
  var main = (function () {
      var addImg = function (h) {
          return function (e) {
              return function (x) {
                  return function __do() {
                      var v = e();
                      return Control_Bind.bind(Effect.bindEffect)(Render.createImage(x))(Data_Function.flip(Web_DOM_Node.appendChild)(Web_DOM_Element.toNode(h)))();
                  };
              };
          };
      };
      return function __do() {
          ...
          var handArr = Data_Array.sort(Mahjong_Hand.ordTile)(Mahjong_Hand.handToList(hand));
          var doc = Data_Functor.map(Effect.functorEffect)(Web_HTML_HTMLDocument.toDocument)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document))();
          var handDiv = Web_DOM_ParentNode.querySelector("#hand")(Web_DOM_Document.toParentNode(doc))();
          var img = Render.createImage(new Mahjong_Hand.Manzu(1))();
          (function () {
              var v = new Data_Tuple.Tuple(handDiv, Data_Array.init(handArr));
              if (v.value0 instanceof Data_Maybe.Just && v.value1 instanceof Data_Maybe.Just) {
                  return Data_Foldable.foldl(Data_Foldable.foldableArray)(addImg(v.value0.value0))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(v.value1.value0)();
              };
              return Data_Unit.unit;
          })();
          var agariDiv = Web_DOM_ParentNode.querySelector("#agari")(Web_DOM_Document.toParentNode(doc))();
          var v = new Data_Tuple.Tuple(agariDiv, Data_Array.last(handArr));
          if (v.value0 instanceof Data_Maybe.Just && v.value1 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Effect.bindEffect)(Render.createImage(v.value1.value0))(Data_Function.flip(Web_DOM_Node.appendChild)(Web_DOM_Element.toNode(v.value0.value0)))();
          };
          return Data_Unit.unit;
      };
  })();
